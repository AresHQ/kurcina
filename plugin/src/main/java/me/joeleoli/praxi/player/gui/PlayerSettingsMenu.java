...
public class PlayerSettingsMenu extends Menu {
	...
	private static class ToggleButton extends Button {
		...
		public ItemStack getButtonItem(Player player) {
			...
			lore.add("");
			lore.add(" " + (this.settingInfo.get(player) ? Style.BLUE + Style.UNICODE_ARROWS_RIGHT : " ") + " " +
			         Style.YELLOW + this.settingInfo.enabledDescription);
			lore.add(" " + (!this.settingInfo.get(player) ? Style.BLUE + Style.UNICODE_ARROWS_RIGHT : " ") + " " +
			         Style.YELLOW + this.settingInfo.disabledDescription);
