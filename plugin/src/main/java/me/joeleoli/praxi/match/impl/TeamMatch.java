...
public class TeamMatch extends Match {
    ...
    public void onEnd() {
        ...
        for (MatchPlayer matchPlayer : winningTeam.getTeamPlayers()) {
            ...
            final ClickEvent click = new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/viewinv " + matchPlayer.getUuid().toString());
        ...
        winnerInventories.getCurrent().setText(winnerInventories.getCurrent().getText().substring(0, winnerInventories.getCurrent().getText().length() - 2));
        loserInventories.getCurrent().setText(loserInventories.getCurrent().getText().substring(0, loserInventories.getCurrent().getText().length() - 2));
