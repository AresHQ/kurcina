                ...
                if (match.getMatchId().equals(damagedData.getMatch().getMatchId())) {
                    ...
                    if (match.isSoloMatch()) {
                        ...
                        if (event.getDamager() instanceof Arrow) {
                            ...
                            attacker.sendMessage(Style.GOLD + "You shot " + Style.AQUA + damaged.getName() + Style.GOLD + "!" + Style.GRAY + " (" + Style.RED + health + Style.DARK_RED + " " + StringEscapeUtils.unescapeJava("\u2764") + Style.GRAY + ")");
                        }
